...
#define PN532_MIFARE_NEW_WRITE 0xA2
...
public:
    ...
    uint32_t readMfulPages(uint8_t cardnumber /*1 or 2*/,uint8_t startPageAddress /*0 to 15*/, uint8_t * pages);
    uint32_t writeMfulPage(uint8_t cardnumber /*1 or 2*/,uint8_t pageAddress /*0 to 15*/, uint8_t * page);
